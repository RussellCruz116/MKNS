...
def run_whatif_scenario(geojson_path, model_path, output_geojson):
    ...
    def apply_ai_physics(row):
        ...
        return pd.Series({'SpeedLimit': limit, 'F85thPercentileSpeed': f85, 'WhatIf_Action_Details': action_text, 'Intervention_Cost': cost, 'BonusScore': bonus})
    ...
    gdf['BonusScore'] = new_physics['BonusScore']
    ...
    # Apply calculated bonus and theoretical limit
    gdf['SpeedSafetyScore'] = np.clip(gdf['SpeedSafetyScore'] + gdf['BonusScore'], 0.0, 100.0)
